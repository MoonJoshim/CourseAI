...
CourseAI는 실제 수강생들의 강의평 데이터를 기반으로 AI 기반 강의 추천, 검색, 분석을 제공하는 풀스택 웹 애플리케이션입니다. RAG(Retrieval-Augmented Generation) 기술을 활용하여 벡터 검색 기반의 정확한 강의 정보를 제공합니다.
...
- 실제 수강생 강의평 기반 평가
- 교수별, 평점별 필터링
- 태그 기반 빠른 검색 (노팀플, 과제많음, 성적잘줌 등)
- 평점, 리뷰 수, 난이도, 과제량 등 상세 정보 제공

### 2. 개설과목 현황
- 2025-2학기 전체 개설과목 조회 (3000+ 과목)
- 전공필수 / 전공선택 / 교양선택 분류
- 강의 시간, 교수, 학점 등 상세 정보
